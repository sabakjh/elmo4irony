...
# HOME_DIR = r"C:\Users\Carl\Desktop\2020Spring\Deep Learning\Assignments\Final_Project\elmo4irony"
HOME_DIR = r"./"
ALLENNLP_PATH = os.path.join(HOME_DIR, 'allennlp')
DATA_PATH = os.path.join(HOME_DIR, 'datasets')
...
ELMO_OPTIONS = os.path.join(
    EMBEDDINGS_DIR, 'elmo_2x4096_512_2048cnn_2xhighway_options.json')
ELMO_WEIGHTS = os.path.join(
    EMBEDDINGS_DIR, 'elmo_2x4096_512_2048cnn_2xhighway_weights.hdf5')
