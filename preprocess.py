...
if __name__ == "__main__":
    ...
    if not os.path.exists(dataset_path):
        raise IOError(
            "Prepared dataset does not exist. Did you create it already?")
    ...
    with open(os.path.join(output_path, 'train_labels.txt'), 'w', encoding="utf-8") as f:
    ...
    with open(os.path.join(output_path, 'dev_labels.txt'), 'w', encoding="utf-8") as f:
    ...
    with open(os.path.join(output_path, 'test_labels.txt'), 'w', encoding="utf-8") as f:
